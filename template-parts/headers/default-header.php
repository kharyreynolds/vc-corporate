<!-- Default Header - White Background/Dark Text -->
<!-- =========================================== -->
<header id="header">
    ...
    <div id="header-wrap">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="<?php $logo = _gop('logo'); echo $logo['url'];  ?>" alt="Canvas Logo"></a>
                <a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="<?php $logo = _gop('logo'); echo $logo['url'];  ?>" alt="Canvas Logo"></a>
            </div><!-- #logo end -->
