<header id="header" class="transparent-header" data-sticky-class="not-dark">
	...
	<div id="header-wrap">
		...
		<div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="index.html" class="standard-logo" data-dark-logo="<?php $logo = _gop('logo'); echo $logo['url'];  ?>"><img src="<?php $logo = _gop('logo'); echo $logo['url'];  ?>" alt="Canvas Logo">
                </a>
                <a href="index.html" class="retina-logo" data-dark-logo="<?php $logo = _gop('logo'); echo $logo['url'];  ?>"><img src="<?php $logo = _gop('logo'); echo $logo['url'];  ?>" alt="Canvas Logo">
                </a>
            </div><!-- #logo end -->
