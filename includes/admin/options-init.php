    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            array(
                ...
                'default'  => array( 'url'=> get_bloginfo( 'template_directory' ) . "/includes/images/vc-icon.png" ),
            ),
            array(
                'id'       => 'logo',
                'type'     => 'media',
                ...
                'default'  => array( 'url'=> get_bloginfo( 'template_directory' ) . "/includes/images/v3-logo.png" ),
            ),
            array(
